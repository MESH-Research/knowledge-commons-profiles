...
MIDDLEWARE = [
    ...
    "knowledge_commons_profiles.common.middleware.MaintenanceReadOnlyMiddleware",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "knowledge_commons_profiles.newprofile.context_processors.maintenance",
            ],
        },
    },
]
...
# SESSIONS
# ------------------------------------------------------------------------------
# Read through the configured Redis cache; persist through to the DB so a
# Redis flush does not log everyone out (#589).
...
# Editor controls intentionally limited to the formatting actions that
# survive sanitisation (issue #540): bold, italic, link, anchor, and
# bulleted/numbered lists. Any other toolbar button would let users add
# formatting that the server-side sanitiser then silently strips on save
# (the original #540 symptom). Plugins are pared back to just what those
# buttons need.
TINYMCE_DEFAULT_CONFIG = {
    ...
    "selector": "textarea",
    "theme": "silver",
    "plugins": "link anchor autolink lists",
    "toolbar1": "bold italic | bullist numlist | link anchor",
    "contextmenu": "link",
    "menubar": False,
    "statusbar": True,
    "promotion": False,
...
WORDPRESS_EMAIL_UPDATE_URL = env("WORDPRESS_EMAIL_UPDATE_URL", default="")
WORDPRESS_AVATAR_UPDATE_URL = env("WORDPRESS_AVATAR_UPDATE_URL", default="")
...
MAILCHIMP_NEWSLETTER_GROUP_ID = env("MAILCHIMP_NEWSLETTER_GROUP_ID")
